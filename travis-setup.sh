# VARIABLES
DEFAULT_APT_DOCKER_PKG="docker-engine=1.12.5-0~ubuntu-xenial"
...
docker_install()
{
  ...
  echo 'deb "https://download.docker.com/repo" ubuntu-xenial main' | sudo tee /etc/apt/sources.list.d/docker.list
  sudo apt-get update
